...
def label_dataset_by_bert(dataset_path, output_path, threshold):
    ...
    result_dir = "DSNoise/WDC/Bert/Threshold" + str(4)
...
def label_dataset_by_SoftTFIDF(dataset_path, output_path, threshold):
    ...
    result_dir = "DSNoise/WDC/SoftTFIDF/Threshold" + str(4)
    if not os.path.exists(result_dir):
        os.makedirs(result_dir)
...
def label_all_dataSets(labeler_name, labeler):
    ...
    # Bert Thresholds
    thresholds = [0.5, 0.55, 0.5, 0.65, 0.65, 0.6, 0.55, 0.55, 0.55, 0.5, 0.65, 0.55]
    ...
    thresholds0.9 = [0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9]  


    # SoftTFIDF Thresholds
    thresholds0.5 = [0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5, 0.5]
    thresholds0.6 = [0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6, 0.6]   
    thresholds0.7 = [0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7, 0.7]
    thresholds0.8 = [0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8, 0.8]   
    thresholds0.75 = [0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 0.75, 0.75] 
