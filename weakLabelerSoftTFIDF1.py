...
def label_dataset_by_bert(dataset_path, output_path, threshold):
    ...
    result_dir = "DSNoise/Magellan/Bert/Threshold" + str(1)
...
def label_dataset_by_SoftTFIDF(dataset_path, output_path, threshold):
    ...
    ds = dataset_path.split("/")[-3] + "/" + dataset_path.split("/")[-2]
    result_dir = "DSNoise/Magellan/SoftTFIDF/Threshold" + str(1)
    if not os.path.exists(result_dir):
        os.makedirs(result_dir)
...
def label_all_dataSets(labeler_name, labeler):
    ...
    thresholds = [0.9, 0.85, 0.8, 0.92, 0.85, 0.9, 0.85, 0.85, 0.85, 0.8, 0.92, 0.85]
    ...
    thresholds5 = [0.75, 0.7, 0.65, 0.8, 0.7, 0.75, 0.7, 0.7, 0.7, 0.65, 0.8, 0.7]
    thresholds6 = [0.65, 0.6, 0.6, 0.75, 0.65, 0.7, 0.65, 0.65, 0.65, 0.6, 0.75, 0.65]
    ...
    thresholds = [0.8, 0.75, 0.75, 0.8, 0.75, 0.75, 0.8, 0.75, 0.4, 0.8, 0.8, 0.5]
    ...
    thresholds5 = [0.65, 0.6, 0.6, 0.65, 0.6, 0.6, 0.65, 0.6, 0.25, 0.65, 0.65, 0.35]
    thresholds6 = [0.6, 0.55, 0.55, 0.6, 0.55, 0.55, 0.6, 0.55, 0.45, 0.6, 0.6, 0.55]
